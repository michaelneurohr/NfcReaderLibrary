...
/** \file
* Example Source for LPC1769 and PN512 or RC663.
...
/**
 * Header for hardware configuration: bus interface, reset of attached
 * reader ID, onboard LED handling etc.
 * */
...
phhalHw_Rc663_DataParams_t         hal;                       /* HAL component holder */
#endif
...
int main (void)
{
    ...
    phhalHw_ReadRegister(pHal, PHHAL_HW_RC663_REG_VERSION, bHalBufferTx);
